  ...
  return (
    <>
      ...
      <PageHero label="About Us" title="Built for the modern crypto investor">
        <p className="page-hero__sub">We believe intelligent tools should be available to everyone, not just Wall Street. That&rsquo;s why we built <strong>Larch Vaultmere</strong>: real-time data, AI-powered strategies and bank-grade security, in one simple platform.</p>
      </PageHero>
      ...
      <section className="section">
        <div className="container security">
          <div className="security__copy">
            ...
            <p className="security__lead">Most people don&rsquo;t have time to watch charts around the clock. We built <strong>Larch Vaultmere</strong> to change that, combining live market data with automated strategies that work while you sleep, so trading fits around your life instead of taking it over.</p>
